...
bucket = storage_client.bucket("sid_bucket1")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "mlopsgcp-440507.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://sid_bucket1/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
